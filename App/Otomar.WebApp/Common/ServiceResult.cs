...
namespace Otomar.WebApp.Common
{
    ...
    public class ServiceResult<T> : ServiceResult
    {
        ...
        public static ServiceResult<T> Error(string title, string description, HttpStatusCode statusCode)
        {
            return new ServiceResult<T>
            {
                StatusCode = statusCode,
        ...
        public static ServiceResult<T> Error(string title, HttpStatusCode statusCode)
        {
            return new ServiceResult<T>
            {
                StatusCode = statusCode,
        ...
        public static ServiceResult<T> ErrorFromValidation(IDictionary<string, object> validationErrors)
        {
            return new ServiceResult<T>
            {
                StatusCode = HttpStatusCode.BadRequest,
