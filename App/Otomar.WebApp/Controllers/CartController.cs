...
namespace Otomar.WebApp.Controllers
{
    ...
    public class CartController(ICartApi cartApi) : Controller
    {
        ...
        [HttpPost("liste-sorgudan-ekle/{requestNo}")]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> AddToCartFromListSearch(string requestNo, CancellationToken cancellationToken = default)
        {
            return await cartApi.AddToCartFromListSearchAsync(requestNo, cancellationToken).ToActionResultAsync();
        }
